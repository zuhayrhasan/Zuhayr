        ...
        <div class="home-cont">
          ...
          <div class="box-text">
            ...
            <p class="small-paragraph">
              As a recent{" "}
              <span class="underline-text">Software Engineering</span> graduate,
              I'm passionate about creating impactful solutions and bringing my
              ideas to life. My expertise lies in{" "}
              <span class="underline-text">JavaScript</span>,{" "}
              <span class="underline-text">React</span>, and{" "}
              <span class="underline-text">RESTful APIs</span>. With a track
              record of success during my internship and collaborative spirit, I{" "}
              <span class="underline-text">thrive</span> in team environments
              and eagerly embrace opportunities to expand my skillset and become
              a <span class="underline-text">better developer</span>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="skills" class="skills-page section">
        ...
        <div class="skills-cont">
          <div class="skills-text-cont">
            <p class="skills-text">
              In my four-year{" "}
              <span class="underline-text">Software Engineering</span>{" "}
              undergrad, I delved into pivotal courses, including:
              ...
              Through these classes, I acquired a{" "}
              <span class="underline-text">spectrum of skills</span> including
              JavaScript, React, HTML, CSS, Python, and SQL. However, I want to
              continue to further{" "}
              <span class="underline-text">expand my horizons</span> in the
        ...
        <div class="contact-cont">
          <div class="contact-text-cont">
            <div class="contact-text">
              <p>
                With an unwavering commitment to my craft, I'm{" "}
                <span class="underline-text">
                  actively pursuing full-time opportunities
                </span>{" "}
                to contribute my skills and enthusiasm to a dynamic team.
              </p>
              <p>
                Don't hesitate to reach out;{" "}
                <span class="underline-text">let's connect</span> and make
                things happen!
              </p>
            </div>
            <div class="socials">
              <div class="socials-square socials-linkedin">
                ...
                <a
                  class="custom-link"
                  href="https://www.linkedin.com/in/zuhayrhasan/"
                  target="_blank"
              ...
              <div class="socials-square socials-github">
                ...
                <a
                  class="custom-link"
                  href="https://github.com/zuhayrhasan/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div class="contact-form-cont">
            <div class="contact-me-container">
              ...
              <form
                target="_blank"
                action="https://formsubmit.co/zuhayrshasan@gmail.com"
                method="POST"
                class="contact-me-form darkgrey-text"
              >
                ...
                <textarea
                  ...
                  name="message"
                  pattern=".{3,}"
                  placeholder="I would like to hire you!"
                  required
                ></textarea>
