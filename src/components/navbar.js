      ...
      <nav id="navbar" class={"navbar" + (isNavHidden ? " hidden" : "")}>
        <ul class="nav-list section-tabs">
          <li>
            <a
              id="home-icon"
              class="selected-icon home-icon option"
              href="#home"
            >
          ...
          <li>
            <a id="skills-icon" class="skills-icon option" href="#skills" n>
              <span class="tab-text">Skills</span>
            </a>
          </li>
          <li>
            <a id="projects-icon" class="projects-icon option" href="#projects">
          ...
          <li>
            <a id="contact-icon" class="contact-icon option" href="#contact">
